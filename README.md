...
<p align="center" class="github-badges">
  ...
  <a href="https://github.com/open-feature/kotlin-sdk/releases/tag/v0.7.3">
    <img alt="Release" src="https://img.shields.io/static/v1?label=release&message=v0.7.3&color=blue&style=for-the-badge" />
  </a>
...
```kotlin
dependencies {
    api("dev.openfeature:kotlin-sdk:0.7.3")
}
```
<!-- x-release-please-end -->
