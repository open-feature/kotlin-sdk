...
<p align="center" class="github-badges">
  ...
  <a href="https://github.com/open-feature/kotlin-sdk/releases/tag/v0.5.2">
    <img alt="Release" src="https://img.shields.io/static/v1?label=release&message=v0.5.2&color=blue&style=for-the-badge" />
  </a>
...
```kotlin
dependencies {
    api("dev.openfeature:android-sdk:0.5.2")
}
```
